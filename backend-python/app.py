...
label_to_statement = {
    0: "{drug_a} can cause a decrease in the absorption of {drug_b} resulting in a reduced serum concentration and potentially a decrease in efficacy",
    1: "{drug_a} can cause an increase in the absorption of {drug_b} resulting in an increased serum concentration and potentially a worsening of adverse effects",
    ...
    25: "The risk or severity of adverse effects can be increased when {drug_a} is combined with {drug_b}",
    ...
    49: "{drug_a} may increase the arrhythmogenic activities of {drug_b}",
    ...
    73: "{drug_a} may increase the orthostatic hypotensive activities of {drug_b}",
    74: "{drug_a} may increase the photosensitizing activities of {drug_b}",
    75: "{drug_a} may increase the QTc-prolonging activities of {drug_b}",
